...
<div class="col-sm-9 col-md-10 mt-5">
  <form class="mx-5" action="" method="POST">
    <div class="form-group">
      <label for="inputRequestInfo">How can we help you?</label>
      <input type="text" class="form-control" id="inputRequestInfo" placeholder="Need a plumber, electrician etc" name="requestinfo">
    </div>
    <div class="form-group">
      <label for="inputRequestDescription">Description</label>
      <input type="text" class="form-control" id="inputRequestDescription" placeholder="Describe your problem" name="requestdesc">
    </div>
    <div class="form-group">
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" id="inputCity" placeholder="Your city" name="requestercity">
      </div>
      <div class="form-group col-md-4">
        <label for="inputState">State</label>
          <select id="inputState" name="requesterstate">
      ...
      <div class="form-group col-md-2">
        ...
        <input type="text" class="form-control" id="inputZip" placeholder="xxxxxx" name="requesterzip" onkeypress="isInputNumber(event)" maxlength="6" pattern="\d{6}" title="Zip code consists of 6 digits!" required>
      </div>
    </div>
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <input type="email" class="form-control" id="inputEmail" placeholder="Your Email here" name="requesteremail">
      </div>
      <div class="form-group col-md-2">
        <label for="inputMobile">Mobile</label>
        <input type="text" class="form-control" id="inputMobile" name="requestermobile" placeholder="Without +91" onkeypress="isInputNumber(event)" maxlength="10" pattern="\d{10}" title="10 digits required!" required>
      </div>
      <div class="form-group col-md-2">
