...
if(!isset($_SESSION['is_adminlogin'])){
  if(isset($_REQUEST['aEmail'])){
    ...
    $sql = "SELECT a_username, a_password FROM adminlogin_tb WHERE a_username='".$aEmail."' AND a_password='".$aPassword."' limit 1";
...
<body>
  ...
  <p class="text-center" style="font-size: 20px;"> <i class="bi bi-person-gear"></i> <span>Admin
      Area</span>
  </p>
