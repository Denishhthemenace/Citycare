...
session_start();
 ...
 if(isset($_REQUEST['empupdate'])){
  ...
  $sql = "UPDATE technician_tb SET empName = '$eName', empCat = '$eCat', empCity = '$eCity', empMobile = '$eMobile', empEmail = '$eEmail' WHERE empid = '$eId'";
 ...
 ?>
  <form action="" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="empCat" name="empCat" value="<?php if(isset($row['empCat'])) {echo $row['empCat']; }?>">
    </div>
    <div class="form-group">
